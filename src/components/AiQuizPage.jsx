  ...
  import fetchAiQuiz from "../redux/actions/aiQuizAction";
  ...
  const navigate = useNavigate();  
    ...
    const { question, score, isLoading, submitedQuestions, error } = useSelector(
      (state) => state.aiquiz
    );
    ...
    {[ "React", "Python", "JavaScript", "Node.js", "CSS", "HTML", 
    "Machine Learning", "Artificial Intelligence", "Nature", "Physics", 
    "Chemistry", "Mathematics", "Blockchain", "Quantum Computing", 
    "Random"].map((topic) => (
      <button
        key={topic}
        onClick={() => setUserPrompt(topic)}
        className={`px-4 py-2 rounded-full border 
          ${userPrompt === topic ? "bg-blue-600 text-white" : " shadow-md cursor-pointer  text-gray-200"} 
      ...
      >
        ...
        {question&& <div className="text-center">
            <button
    ...
    return (
      <div className="min-h-screen bg-gradient-to-r  from-indigo-600 via-purple-600 to-pink-600  flex flex-col items-center justify-center px-4 py-8 space-y-10">
        ...
        <div className="max-w-2xl bg-black w-full rounded-lg shadow-lg p-6 space-y-4">
          <h2 className="text-xl font-boldtext-center ">
            Your Answers
          </h2>
